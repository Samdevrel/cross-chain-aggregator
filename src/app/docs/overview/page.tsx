      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Unified interface for interacting with multiple blockchains and dApps across the entire ecosystem.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Single interface for all chains</li>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li>✓ Unified dashboard across chains</li>
            <li>✓ Cross-chain swap</li>
            <li>✓ Portfolio aggregation</li>
            <li>✓ Real-time chain status</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Add desired chains</li>
            <li>View portfolio across chains</li>
            <li>Execute cross-chain transactions</li>
          </ol>
        </section>
